...
namespace UnityEditor
{
	internal class ParticleEffectUI
	{
		...
		internal void PlayBackInfoGUI(bool isPlayMode)
		{
			...
			{
				uint arg_3C2_0 = ParticleSystemEditorUtils.editorPreviewLayers;
		...
		internal static void SetPreviewLayersDelegate(object userData, string[] options, int selected)
		{
			...
			ParticleSystemEditorUtils.editorPreviewLayers = SerializedProperty.ToggleLayerMask(tuple.Item2, selected);
		}
		...
		internal void PlayStopGUI()
		{
			...
			if (!EditorApplication.isPlaying)
			{
				...
				{
					bool flag2 = ParticleSystemEditorUtils.editorIsPlaying && !ParticleSystemEditorUtils.editorIsPaused && !flag;
