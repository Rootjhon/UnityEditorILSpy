...
namespace UnityEditor
{
	internal class ProjectBrowserColumnOneTreeViewDataSource : TreeViewDataSource
	{
		...
		public override void FetchData()
		{
			...
			{
				string guid = AssetDatabase.AssetPathToGUID(AssetDatabase.GetPackagesMountPoint());
				...
				treeViewItem2 = new TreeViewItem(instanceIDFromGUID, num, this.m_RootItem, packagesMountPoint);
